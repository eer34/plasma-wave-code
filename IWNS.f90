    ...
    program IWNS
        ...
        do k=1,71
			omega_pe_div_omega_square=940.0_wp
        ...
        call set_parameter_variable_k_para(c_div_v_para_input,omega_pe_div_omega_ce_input,omega_div_omega_ci_input,k_per_rho_i_input)
        left_edge=0.1_wp
		right_edge=10.0_wp
		down_edge=-10.0_wp
		up_edge=-0.1_wp
		...
		call zero_pole_location(dispersion_function_parallel_variable_k_para,ierr,left_edge,right_edge,down_edge,up_edge,kc_square,epsilon_i,epsilon_accuracy_limit,n_circle,n_line,epsilon_0,z_solve_number,ans_z_solve,ans_mul_solve,ans_z_error,ans_f_solve)
